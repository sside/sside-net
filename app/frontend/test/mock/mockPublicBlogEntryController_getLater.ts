...
export const mockValuePublicBlogEntryController_getLater = {
...
export const mockPublicBlogEntryController_getLater = (
    mswFixture: MswFixture,
) => {
    mockBackendGetResponse(
        `/blog-entry/later`,
        mockValuePublicBlogEntryController_getLater,
        mswFixture,
    );
};
