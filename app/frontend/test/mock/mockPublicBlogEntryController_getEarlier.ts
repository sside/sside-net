...
export const mockValuePublicBlogEntryController_getEarlier = {
...
export const mockPublicBlogEntryController_getEarlier = (
    mswFixture: MswFixture,
) => {
    mockBackendGetResponse(
        `/blog-entry/earlier`,
        mockValuePublicBlogEntryController_getEarlier,
        mswFixture,
    );
};
